...
def sort_df(df,exchange):
    ...
    return (symbol, sgk.iloc[-1]['CumNetShort'])
...
def main(start_date, end_date, exchanges, shortdata_dir, graphics =True):
    ...
    for exchange in exchanges:
        ...
        netshorted.append(sort_df(df, exchange))
